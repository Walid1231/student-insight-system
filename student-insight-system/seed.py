...
STUDENTS = [
    ...
    },
    {
        ...
        "dept": "Computer Science", "class_lvl": "3", "section": "A",
        "cgpa": 3.82, "target": 4.0, "semester": 5, "credits": 75,
        "career_idx": 0, "gpa_trend": [3.5, 3.7, 3.8, 3.8, 3.82],
        "skills": [("Python", 88, 0.12), ("Data Structures", 85, 0.15), ("Java", 80, 0.20)],
        "weekly_hrs": 28, "burnout": 0.3, "goal_prob": 0.88,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000001",
    },
    {
        "name": "James Chen", "email": "james.chen@student.edu",
        "dept": "Engineering", "class_lvl": "2", "section": "B",
        "cgpa": 2.45, "target": 3.0, "semester": 3, "credits": 45,
        "career_idx": 2, "gpa_trend": [2.8, 2.5, 2.45],
        "skills": [("AutoCAD", 65, 0.40), ("Physics", 55, 0.60), ("Problem Solving", 60, 0.50)],
        "weekly_hrs": 15, "burnout": 0.6, "goal_prob": 0.4,
        "status": "Needs Attention", "alert": ("performance", "medium", "GPA slip in core subjects"),
        "student_code": "3000000000000002",
    },
    {
        "name": "Sofia Rossi", "email": "sofia.rossi@student.edu",
        "dept": "Business", "class_lvl": "4", "section": "C",
        "cgpa": 3.95, "target": 4.0, "semester": 7, "credits": 105,
        "career_idx": 4, "gpa_trend": [3.8, 3.9, 3.9, 3.95],
        "skills": [("Marketing", 92, 0.05), ("Communication", 95, 0.05), ("Strategy", 88, 0.10)],
        "weekly_hrs": 20, "burnout": 0.15, "goal_prob": 0.95,
        "status": "Excellent", "alert": None,
        "student_code": "3000000000000003",
    },
    {
        "name": "Lucas Silva", "email": "lucas.silva@student.edu",
        "dept": "Computer Science", "class_lvl": "1", "section": "A",
        "cgpa": 3.1, "target": 3.5, "semester": 2, "credits": 30,
        "career_idx": 7, "gpa_trend": [3.0, 3.1],
        "skills": [("SQL", 70, 0.30), ("Python", 75, 0.25), ("Intro to AI", 65, 0.40)],
        "weekly_hrs": 18, "burnout": 0.35, "goal_prob": 0.65,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000004",
    },
    {
        "name": "Amina Diop", "email": "amina.diop@student.edu",
        "dept": "Computer Science", "class_lvl": "3", "section": "B",
        "cgpa": 2.15, "target": 2.8, "semester": 6, "credits": 90,
        "career_idx": 6, "gpa_trend": [2.8, 2.5, 2.3, 2.2, 2.15],
        "skills": [("Project Management", 50, 0.70), ("Java", 45, 0.75), ("Database Systems", 55, 0.65)],
        "weekly_hrs": 10, "burnout": 0.8, "goal_prob": 0.25,
        "status": "Critical", "alert": ("performance", "high", "High risk of failing core databases class"),
        "student_code": "3000000000000005",
    },
    {
        "name": "Liam MacDonald", "email": "liam.mac@student.edu",
        "dept": "Engineering", "class_lvl": "4", "section": "A",
        "cgpa": 3.65, "target": 3.8, "semester": 8, "credits": 120,
        "career_idx": 2, "gpa_trend": [3.4, 3.5, 3.6, 3.65],
        "skills": [("Circuit Analysis", 85, 0.15), ("MATLAB", 82, 0.18), ("Calculus", 80, 0.20)],
        "weekly_hrs": 35, "burnout": 0.45, "goal_prob": 0.85,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000006",
    },
    {
        "name": "Chloe Wong", "email": "chloe.wong@student.edu",
        "dept": "Business", "class_lvl": "2", "section": "C",
        "cgpa": 2.75, "target": 3.2, "semester": 4, "credits": 60,
        "career_idx": 3, "gpa_trend": [2.6, 2.9, 2.8, 2.75],
        "skills": [("Accounting", 65, 0.40), ("Economics", 70, 0.35), ("Public Speaking", 75, 0.30)],
        "weekly_hrs": 20, "burnout": 0.5, "goal_prob": 0.55,
        "status": "Needs Attention", "alert": None,
        "student_code": "3000000000000007",
    },
    {
        "name": "Ethan Wright", "email": "ethan.wright@student.edu",
        "dept": "Computer Science", "class_lvl": "1", "section": "B",
        "cgpa": 3.85, "target": 4.0, "semester": 1, "credits": 15,
        "career_idx": 0, "gpa_trend": [3.85],
        "skills": [("Python", 85, 0.15), ("Git", 80, 0.20), ("Web Development", 90, 0.10)],
        "weekly_hrs": 25, "burnout": 0.2, "goal_prob": 0.9,
        "status": "Excellent", "alert": None,
        "student_code": "3000000000000008",
    },
    {
        "name": "Maya Patel", "email": "maya.patel@student.edu",
        "dept": "Engineering", "class_lvl": "3", "section": "A",
        "cgpa": 3.4, "target": 3.5, "semester": 6, "credits": 90,
        "career_idx": 2, "gpa_trend": [3.2, 3.3, 3.4, 3.4, 3.4],
        "skills": [("Thermodynamics", 80, 0.20), ("SolidWorks", 88, 0.12), ("Math", 85, 0.15)],
        "weekly_hrs": 30, "burnout": 0.35, "goal_prob": 0.8,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000009",
    },
    {
        "name": "Jackson Davis", "email": "jackson.davis@student.edu",
        "dept": "Business", "class_lvl": "1", "section": "B",
        "cgpa": 1.95, "target": 2.5, "semester": 2, "credits": 30,
        "career_idx": 3, "gpa_trend": [2.2, 1.95],
        "skills": [("Finance", 40, 0.80), ("Management", 50, 0.60), ("Excel", 45, 0.70)],
        "weekly_hrs": 8, "burnout": 0.75, "goal_prob": 0.2,
        "status": "Critical", "alert": ("attendance", "high", "Frequent absences detected"),
        "student_code": "3000000000000010",
    },
    {
        "name": "Ananya Sharma", "email": "ananya.sharma@student.edu",
        "dept": "Computer Science", "class_lvl": "4", "section": "C",
        "cgpa": 3.98, "target": 4.0, "semester": 8, "credits": 120,
        "career_idx": 1, "gpa_trend": [3.9, 3.95, 3.98, 3.98],
        "skills": [("Deep Learning", 95, 0.05), ("TensorFlow", 92, 0.08), ("NLP", 90, 0.10)],
        "weekly_hrs": 32, "burnout": 0.3, "goal_prob": 0.98,
        "status": "Excellent", "alert": None,
        "student_code": "3000000000000011",
    },
    {
        "name": "Oliver Kim", "email": "oliver.kim@student.edu",
        "dept": "Engineering", "class_lvl": "2", "section": "A",
        "cgpa": 2.85, "target": 3.3, "semester": 3, "credits": 45,
        "career_idx": 2, "gpa_trend": [2.9, 2.8, 2.85],
        "skills": [("AutoCAD", 75, 0.30), ("Mechanics", 65, 0.40), ("Teamwork", 80, 0.20)],
        "weekly_hrs": 18, "burnout": 0.45, "goal_prob": 0.6,
        "status": "Needs Attention", "alert": None,
        "student_code": "3000000000000012",
    },
    {
        "name": "Fatou Ndiaye", "email": "fatou.n@student.edu",
        "dept": "Business", "class_lvl": "3", "section": "A",
        "cgpa": 3.55, "target": 3.8, "semester": 5, "credits": 75,
        "career_idx": 3, "gpa_trend": [3.4, 3.5, 3.55],
        "skills": [("Leadership", 88, 0.15), ("Economics", 82, 0.20), ("Statistics", 78, 0.25)],
        "weekly_hrs": 24, "burnout": 0.4, "goal_prob": 0.75,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000013",
    },
    {
        "name": "William Torres", "email": "william.torres@student.edu",
        "dept": "Computer Science", "class_lvl": "2", "section": "B",
        "cgpa": 2.25, "target": 3.0, "semester": 4, "credits": 60,
        "career_idx": 0, "gpa_trend": [2.6, 2.4, 2.1, 2.25],
        "skills": [("C++", 55, 0.60), ("Algorithms", 50, 0.65), ("Linux", 60, 0.50)],
        "weekly_hrs": 14, "burnout": 0.7, "goal_prob": 0.35,
        "status": "Critical", "alert": ("performance", "medium", "Struggling with DS & Algorithms"),
        "student_code": "3000000000000014",
    },
    {
        "name": "Zoe Nguyen", "email": "zoe.nguyen@student.edu",
        "dept": "Computer Science", "class_lvl": "4", "section": "A",
        "cgpa": 3.78, "target": 3.9, "semester": 7, "credits": 105,
        "career_idx": 4, "gpa_trend": [3.6, 3.7, 3.75, 3.78],
        "skills": [("UI/UX Design", 92, 0.10), ("Figma", 95, 0.05), ("React", 85, 0.15)],
        "weekly_hrs": 26, "burnout": 0.35, "goal_prob": 0.88,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000015",
    },
    {
        "name": "Omar Farooq", "email": "omar.farooq@student.edu",
        "dept": "Engineering", "class_lvl": "1", "section": "C",
        "cgpa": 3.25, "target": 3.6, "semester": 1, "credits": 15,
        "career_idx": 2, "gpa_trend": [3.25],
        "skills": [("Physics", 75, 0.30), ("Math", 80, 0.25), ("Critical Thinking", 78, 0.28)],
        "weekly_hrs": 20, "burnout": 0.25, "goal_prob": 0.7,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000016",
    },
    {
        "name": "Hannah Cohen", "email": "hannah.cohen@student.edu",
        "dept": "Business", "class_lvl": "3", "section": "B",
        "cgpa": 3.92, "target": 4.0, "semester": 6, "credits": 90,
        "career_idx": 3, "gpa_trend": [3.8, 3.85, 3.9, 3.92],
        "skills": [("Business Strategy", 90, 0.12), ("Excel", 95, 0.05), ("Sales", 85, 0.15)],
        "weekly_hrs": 22, "burnout": 0.2, "goal_prob": 0.94,
        "status": "Excellent", "alert": None,
        "student_code": "3000000000000017",
    },
    {
        "name": "Ali Hassan", "email": "ali.hassan2@student.edu",
        "dept": "Computer Science", "class_lvl": "2", "section": "A",
        "cgpa": 2.65, "target": 3.0, "semester": 3, "credits": 45,
        "career_idx": 5, "gpa_trend": [2.5, 2.6, 2.65],
        "skills": [("Networking", 68, 0.40), ("Cybersecurity", 70, 0.35), ("Linux", 65, 0.45)],
        "weekly_hrs": 16, "burnout": 0.55, "goal_prob": 0.45,
        "status": "Needs Attention", "alert": ("attendance", "medium", "Occasional missed classes"),
        "student_code": "3000000000000018",
    },
    {
        "name": "Isabella Gomez", "email": "isabella.gomez@student.edu",
        "dept": "Engineering", "class_lvl": "3", "section": "C",
        "cgpa": 3.72, "target": 3.8, "semester": 5, "credits": 75,
        "career_idx": 2, "gpa_trend": [3.6, 3.65, 3.7, 3.72],
        "skills": [("AutoCAD", 85, 0.15), ("Materials Science", 82, 0.18), ("Problem Solving", 88, 0.12)],
        "weekly_hrs": 28, "burnout": 0.38, "goal_prob": 0.86,
        "status": "On Track", "alert": None,
        "student_code": "3000000000000019",
    },
    {
        "name": "Kevin Brooks", "email": "kevin.brooks@student.edu",
        "dept": "Computer Science", "class_lvl": "4", "section": "B",
        "cgpa": 1.75, "target": 2.5, "semester": 8, "credits": 120,
        "career_idx": 0, "gpa_trend": [2.2, 2.0, 1.8, 1.75],
        "skills": [("Python", 40, 0.85), ("Data Structures", 35, 0.90), ("Git", 45, 0.80)],
        "weekly_hrs": 6, "burnout": 0.9, "goal_prob": 0.1,
        "status": "Critical", "alert": ("performance", "high", "At risk of failing graduation requirements"),
        "student_code": "3000000000000020",
    },
]
